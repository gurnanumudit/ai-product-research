...
export default function ReasoningArticle() {
  ...
  return <div className={`${base.page} ${styles.page}`}>
    ...
    <main>
      <header className={`${base.hero} ${styles.hero}`}><p className={base.eyebrow}>AI economics{!reasoningPublished && " · Review draft"}</p><h1>When is more<br />reasoning worth it?</h1><p className={base.subtitle}>The cheapest answer is not always the best choice. We tested three models at three reasoning settings to see when paying more was worthwhile.</p><p className={base.byline}>Mudit Gurnani <span>·</span> <time dateTime="2026-09-24">September 24, 2026</time>{!reasoningPublished && <> <span>·</span> Unpublished</>}</p><p className={base.resourceLine}><a href="https://github.com/gurnanumudit/ai-product-research/tree/main/research/reasoning-costs">Study code and results ↗</a></p></header>
